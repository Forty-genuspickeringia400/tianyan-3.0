...
- generated_at: 2026-03-30T01:56:11.712Z
...
4. 想做 OpenClaw skill 安装：读 `skill-pack/README.md`，再下载 `skill-pack/produce-an-openclaw-skill-blueprint-for-build-a-0.1.0-task.99ffce.skill`.
...
- `skill-pack/produce-an-openclaw-skill-blueprint-for-build-a/SKILL.md`：最终 SKILL.md
- `skill-pack/produce-an-openclaw-skill-blueprint-for-build-a-0.1.0-task.99ffce.skill`：可分发的 .skill 文件
...
- `skill-pack/produce-an-openclaw-skill-blueprint-for-build-a/SKILL.md`
