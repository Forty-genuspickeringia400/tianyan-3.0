...
- generated_at: 2026-03-30T01:56:12.116Z
...
4. 想做 OpenClaw skill 安装：读 `skill-pack/README.md`，再下载 `skill-pack/produce-a-runtime-operations-playbook-for-build-a-0.1.0-task.991340.skill`.
...
- `skill-pack/produce-a-runtime-operations-playbook-for-build-a/SKILL.md`：最终 SKILL.md
- `skill-pack/produce-a-runtime-operations-playbook-for-build-a-0.1.0-task.991340.skill`：可分发的 .skill 文件
...
- `skill-pack/produce-a-runtime-operations-playbook-for-build-a/SKILL.md`
