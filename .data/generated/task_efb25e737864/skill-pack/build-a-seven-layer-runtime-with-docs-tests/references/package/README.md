...
- generated_at: 2026-03-30T01:56:11.323Z
...
4. 想做 OpenClaw skill 安装：读 `skill-pack/README.md`，再下载 `skill-pack/build-a-seven-layer-runtime-with-docs-tests-0.1.0-task.737864.skill`.
...
- `skill-pack/build-a-seven-layer-runtime-with-docs-tests/SKILL.md`：最终 SKILL.md
- `skill-pack/build-a-seven-layer-runtime-with-docs-tests-0.1.0-task.737864.skill`：可分发的 .skill 文件
...
- `skill-pack/build-a-seven-layer-runtime-with-docs-tests/SKILL.md`
