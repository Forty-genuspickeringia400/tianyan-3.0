---
name: "build-a-seven-layer-runtime-with-docs-tests"
description: "Generated by AgentX 3.0 0.1.0 from task task_efb25e737864. Use when the user needs the packaged delivery flow for: Build a seven-layer runtime with docs, tests, api, implementation and installable skill pack"
---
...
- 用户的目标与这次任务接近：Build a seven-layer runtime with docs, tests, api, implementation and installable skill pack
...
4. 如需确定性查看目录与内容，运行 `scripts/build-a-seven-layer-runtime-with-docs-tests.js`。

## Helper script

```bash
node skills/agentx-3-generated--build-a-seven-layer-runtime-with-docs-tests/scripts/build-a-seven-layer-runtime-with-docs-tests.js summary
node skills/agentx-3-generated--build-a-seven-layer-runtime-with-docs-tests/scripts/build-a-seven-layer-runtime-with-docs-tests.js files
node skills/agentx-3-generated--build-a-seven-layer-runtime-with-docs-tests/scripts/build-a-seven-layer-runtime-with-docs-tests.js read product-brief.md
node skills/agentx-3-generated--build-a-seven-layer-runtime-with-docs-tests/scripts/build-a-seven-layer-runtime-with-docs-tests.js manifest
```
