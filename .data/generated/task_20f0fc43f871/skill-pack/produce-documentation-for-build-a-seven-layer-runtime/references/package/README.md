...
- generated_at: 2026-03-30T01:56:14.218Z
...
4. 想做 OpenClaw skill 安装：读 `skill-pack/README.md`，再下载 `skill-pack/produce-documentation-for-build-a-seven-layer-runtime-0.1.0-task.43f871.skill`.
...
- `skill-pack/produce-documentation-for-build-a-seven-layer-runtime/SKILL.md`：最终 SKILL.md
- `skill-pack/produce-documentation-for-build-a-seven-layer-runtime-0.1.0-task.43f871.skill`：可分发的 .skill 文件
...
- `skill-pack/produce-documentation-for-build-a-seven-layer-runtime/SKILL.md`
