...
- generated_at: 2026-03-30T01:56:13.060Z
...
4. 想做 OpenClaw skill 安装：读 `skill-pack/README.md`，再下载 `skill-pack/produce-an-api-contract-for-build-a-seven-0.1.0-task.e9bae2.skill`.
...
- `skill-pack/produce-an-api-contract-for-build-a-seven/SKILL.md`：最终 SKILL.md
- `skill-pack/produce-an-api-contract-for-build-a-seven-0.1.0-task.e9bae2.skill`：可分发的 .skill 文件
...
- `skill-pack/produce-an-api-contract-for-build-a-seven/SKILL.md`
