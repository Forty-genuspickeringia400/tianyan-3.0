...
- skill_version: 0.1.0-task.3bd3fe
- format: openclaw-skill-pack@3
- generated_skill_format: agentx-generated-skill@3
- install_layout: skills/agentx-3-generated--produce-an-implementation-plan-for-build-a-seven
- install_strategy: managed-auto-install-with-verification

## Install

1. 下载 `skill-pack/produce-an-implementation-plan-for-build-a-seven-0.1.0-task.3bd3fe.skill`，或直接复制 `skill-pack/produce-an-implementation-plan-for-build-a-seven` 目录。
2. 放入 OpenClaw 工作区的 `skills/agentx-3-generated--produce-an-implementation-plan-for-build-a-seven`。
3. 最终路径应类似：`<workspace>/skills/agentx-3-generated--produce-an-implementation-plan-for-build-a-seven/SKILL.md`。
...
- installable directory: `skill-pack/produce-an-implementation-plan-for-build-a-seven`
- final SKILL.md: `skill-pack/produce-an-implementation-plan-for-build-a-seven/SKILL.md`
- skill.json: `skill-pack/produce-an-implementation-plan-for-build-a-seven/skill.json`
- helper script: `skill-pack/produce-an-implementation-plan-for-build-a-seven/scripts/produce-an-implementation-plan-for-build-a-seven.js`
- installation receipt: `skill-pack/installation.json`
- distribution archive: `skill-pack/produce-an-implementation-plan-for-build-a-seven-0.1.0-task.3bd3fe.skill`

## Suggested Reading Order

1. `skill-pack/produce-an-implementation-plan-for-build-a-seven/SKILL.md`
2. `skill-pack/produce-an-implementation-plan-for-build-a-seven/references/package/README.md`
3. `skill-pack/produce-an-implementation-plan-for-build-a-seven/references/package/bundle/bundle.md`
4. `skill-pack/produce-an-implementation-plan-for-build-a-seven/references/package/skill-blueprint.md`
