---
name: "produce-an-implementation-plan-for-build-a-seven"
description: "Generated by AgentX 3.0 0.1.0 from task task_7111763bd3fe. Use when the user needs the packaged delivery flow for: Produce an implementation plan for: Build a seven-layer runtime with docs, tests, api, implementation and installable s…"
---
...
- 用户的目标与这次任务接近：Produce an implementation plan for: Build a seven-layer runtime with docs, tests, api, implementation and installable s…
...
4. 如需确定性查看目录与内容，运行 `scripts/produce-an-implementation-plan-for-build-a-seven.js`。

## Helper script

```bash
node skills/agentx-3-generated--produce-an-implementation-plan-for-build-a-seven/scripts/produce-an-implementation-plan-for-build-a-seven.js summary
node skills/agentx-3-generated--produce-an-implementation-plan-for-build-a-seven/scripts/produce-an-implementation-plan-for-build-a-seven.js files
node skills/agentx-3-generated--produce-an-implementation-plan-for-build-a-seven/scripts/produce-an-implementation-plan-for-build-a-seven.js read product-brief.md
node skills/agentx-3-generated--produce-an-implementation-plan-for-build-a-seven/scripts/produce-an-implementation-plan-for-build-a-seven.js manifest
```
